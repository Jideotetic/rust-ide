...
function Header() {
    ...
    return (
        <header
            id="header"
            className="grid grid-cols-3 gap-6 border-b border-vsdark-3 p-2 mb-1"
        >
            <div className="flex items-center gap-2 px-2">
                ...
                <div className="flex items-center text-xs">
                    {headerLinks.map((item) => (
                        <button
                            className="py-1 text-white px-2.5 rounded hover:bg-neutral-500"
                            key={item}
                        >
                            {item}
                        </button>
